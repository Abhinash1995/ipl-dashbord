...
public class RecordLineMapper implements LineMapper<DataEntity> {
    @Override
    ...
    private ControlRecord mapControlRecord(String line) {
        ...
        String date = line.substring(14, 41);
//        controlRecord.setOrderDate(LocalDateTime.parse(date, inputFormatter)); // Assuming orderDate is from position 15 to 40
